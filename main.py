...
# TODO: Дописать все методы из CRUD - закрыл
# TODO: С помощью библиотеки httpx вызывать каждый роут свой собственный - закрыл

# TODO: добавить многопоточность + использовать lock (замок) для блокировки одновременного запроса)
# TODO: переписать на ассинхронную функции
# TODO: поднять БД postgreSQL
